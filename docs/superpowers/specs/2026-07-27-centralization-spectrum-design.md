...
| 开关 | C0 | C1 | C2 | C3 | C4 | C5 | C6 |
|---|---|---|---|---|---|---|---|
| 领 task/对 WORLD 交付 | 所有人 | **仅 iface** | 所有人 | 所有人 | 所有人 | 所有人 | 单 agent |
| 解题记忆 | 私有 | 私有 | **全员共享** | 私有 | 私有 | 私有 | 私有 |
| 合同定价 | 议价 | 议价 | 议价 | **iface 裁定** | 议价 | 议价* | — |
| 借贷出借人 | 任意 | 任意 | 任意 | 任意 | **仅 iface** | 任意* | — |
| 通信/交易对象 | 任意 | 任意 | 任意 | 任意 | 任意 | **仅 iface** | — |
| agent 数 | 8 | 1+7 | 8 | 1+7 | 1+7 | 1+7 | 1 |
