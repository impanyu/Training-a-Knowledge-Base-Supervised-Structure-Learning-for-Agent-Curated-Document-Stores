...
RETRIEVAL_SKILL = (
    ...
    "  search(query, k) - the notes whose text is most similar to your "
...
CURATION_SKILL = (
    ...
    "judgement.\n"
    "  - search(query, k) returns the k most similar notes, k defaulting "
    ...
    "search(\"job is cooper\", k=40) -> add(\"People whose job is "
