...
CURATION_SKILL = (
    ...
    "judgement.\n"
    "  - search returns the five most similar notes, which is what the "
    "reader you are building for gets and is not enough to enumerate a "
    "set: the residents of a city come back as the same five however "
    "often you ask. search_topk is the same search with a k you choose, "
    "defaulting to five and going up to sixty. When five is plainly not "
    "the whole set, raise k; the set is closed when raising it further "
    "returns nobody new.\n"
...
search_topk(\"lives in the city of "
    ...
    "search_topk(\"job is cooper\", k=40) -> add(\"People whose job is "
