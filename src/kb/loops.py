...
CURATION_SKILL = (
    ...
    "  (1) new INDEX note: add(\"Residents of Fenmarch\") -> n90. Named "
    "the way a searcher would phrase the key, so the next question "
    "mentioning Fenmarch lands on it.\n"
    "  (4) index to statement: link(n90, n44), link(n90, n51), "
    "link(n90, n77) - the residents you could find. This is what makes "
    "n90 an index rather than a label. Left unlinked it would be worth "
    "nothing; linked to three of fourteen it is worth little, so come "
    "back and extend it when Fenmarch comes up again rather than adding "
    "a second one.\n"
    "  (5) index to index: a later question about coopers makes you "
    "add(\"People whose job is cooper\") -> n95; link(n95, n90) records "
    "that Fenmarch is where some of them live, so \"cooper in Fenmarch\" "
    "becomes two reads instead of a blind search.\n"
    "  (2) new STATEMENT note: while linking you notice the store never "
    "says how many people live in Fenmarch, and more than one kind of "
    "question would want that: add(\"Fenmarch has fourteen residents.\") "
    "-> n96, then link(n90, n96). One fact, one note - had you also "
    "wanted to record when Fenmarch was founded, that is a second note, "
    ...
    "first on structure many kinds of question can use, and on this only "
    "if room is left.\n"
