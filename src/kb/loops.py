...
CURATION_SKILL = (
    ...
    "one question would want it, not when it merely records the answer "
    "you were just given. ONE note holds ONE statement. If what you want "
    ...
    "  What you did NOT do: add a note saying Tomas Ashford is the "
    "cooper who lives in Fenmarch. That is the answer you were just "
    "given, and it serves exactly the question that will not be asked "
    "again.\n"
